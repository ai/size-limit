...
it('supports glob and main field', async () => {
  expect(await check('glob')).toEqual({
    checks: [
      {
        files: [fixture('glob', 'a1.js'), fixture('glob', 'a2.js')],
        limit: '1 kB',
        name: 'a',
        path: ['a*.js'],
        sizeLimit: 1000
      ...
      {
        files: [fixture('glob', 'b1.js')],
        name: 'b'
      },
      {
        files: [fixture('glob', 'a1.js'), fixture('glob', 'b1.js')],
        name: 'c',
        path: ['*.js', '!a2.js']
      }
    ],
